...
const char* requirements[] = {
									"[Titul] Musíte mít alespoò %u yang pro aktivaci!", 
									"[Titul] Musíte mít minimální úroveò %u pro aktivaci!",
									"[Titul] Musíte mít nahráno minimálnì: %u"};							
const char* title_translate[] = {
									"[Titul] Musíte poèkat %u hodin pro nákup!",
									"[Titul] Ve svém úètu nemáte dost mincí! Prosím, úètujte to!",
									"[Titul] Bonusy které titul pøidával byli odebrány !",
									"[Titul] Titul byl odebrán, lektvar ti byl navrácen!",
									"[Titul] Titul byl odebrán, lektvar ti byl navrácen!",							
									"[Titul] Titul byl odebrán, lektvar ti byl navrácen!",
									"[Titul] Nemáš prestižní titul!",
									"[Titul] Máš aktivní prestižní titul!",
									"[Titul] Tento titul máš aktivován!",
									"[Titul] potøebiješ x1 Zaèarovaný žlutý lektvar!",
									"[Titul] potøebiješ x1 Zaèarovaný rùžový lektvar!",
									"[Titul] potøebiješ x1 Zaèarovaný Bílí lektvar!",
									"[Titul] Titul ti byl odebrán!"};						
