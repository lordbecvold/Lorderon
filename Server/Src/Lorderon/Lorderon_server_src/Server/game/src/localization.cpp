...
bool LocalizationManager::Send_Localization_Open(LPCHARACTER ch, bool refresh)
{
	...
	int registerPos[2][7] =
	{
		{(ch->GetQuestFlag(strLine_x1)), (ch->GetQuestFlag(strLine_x2)), (ch->GetQuestFlag(strLine_x3)), (ch->GetQuestFlag(strLine_x4)), (ch->GetQuestFlag(strLine_x5)), (ch->GetQuestFlag(strLine_x6)), (ch->GetQuestFlag(strLine_x7))}, {(ch->GetQuestFlag(strLine_y1)), (ch->GetQuestFlag(strLine_y2)), (ch->GetQuestFlag(strLine_y3)), (ch->GetQuestFlag(strLine_y4)), (ch->GetQuestFlag(strLine_y5)), (ch->GetQuestFlag(strLine_y6)), (ch->GetQuestFlag(strLine_y7))}
	};
	char buf[512+1];
...
bool LocalizationManager::Send_Localization_Save(LPCHARACTER ch, int tmpIndex)
{
	...
	int arrayMapIndexBlocked[] = {
		66, 208, 29, 28, 22, 21, 19, 8, 14 /* Settings mapIndex what you want to blocked on save locations, you can put what u want. */
	};
