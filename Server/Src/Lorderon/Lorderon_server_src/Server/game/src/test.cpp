					...
					case COLLISION_TYPE_PLANE:
						printf("P");
						{
							...
							for (int iPairIndex = 0; iPairIndex < 6; iPairIndex++)
							{
								...
								{
									sys_log(0, "Block too big: %d %d %d %d", iBaseX + (int)  PlaneData.v3QuadPosition[iFrom].x, iBaseY + (int) -PlaneData.v3QuadPosition[iFrom].y, iBaseX + (int)  PlaneData.v3QuadPosition[iTo].x, iBaseY + (int) -PlaneData.v3QuadPosition[iTo].y);
								}
								else
								{
