...
#define MAINTENANCE_ADMIN_NAME	"[Owner]Lordbecvold" // Name for acces
#define MAINTENANCE_ADMIN_IP	"0.0.0.0" // Ip for acces

extern const char* maintenance_translate[] = {"-----------------------------------------------------------------------------------",
												"<Syntax> Use: /maintenance 400 400 (time = seconds)",
												"<Syntax> Use: /m_text enable [text]",
