...
const int poison_damage_rate[MOB_RANK_MAX_NUM] = {80, 50, 40, 30, 25, 1};
...
const int bleeding_damage_rate[MOB_RANK_MAX_NUM] = {80, 50, 40, 30, 25, 1};
...
EVENTINFO(TFireEventInfo)
{
	...
	int amount;
	DWORD attacker_pid;
	TFireEventInfo() : ch(), count(0), amount(0), attacker_pid(0)
	{ }
};
...
static int poison_level_adjust[9] = {100, 90, 80, 70, 50, 30, 10, 5, 0};
#ifdef ENABLE_WOLFMAN_CHARACTER
static int bleeding_level_adjust[9] = {100, 90, 80, 70, 50, 30, 10, 5, 0};
#endif
