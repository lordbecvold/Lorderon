...
public:
	...
	void Init(SpherePackFactory *factory, const Vector3d &pos, float radius, void *userdata, bool isSphere)          
	{
		IS_SPHERE			= isSphere;
		mUserData         = userdata;
		mParent           = 0;
	...
	void RayTrace(const Vector3d &p1, const Vector3d &dir, float distance, SpherePackCallback *callback);
...
public:
	...
	void RayTrace(const Vector3d &p1, const Vector3d &p2, SpherePackCallback *callback);
	...
	virtual void RayTraceCallback(const Vector3d &p1, const Vector3d &dir, float distance, const Vector3d &sect, SpherePack *sphere);
