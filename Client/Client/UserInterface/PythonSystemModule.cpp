...
PyObject * systemGetWindowStatus(PyObject* poSelf, PyObject* poArgs)
{
	...
	return Py_BuildValue("iiiii", c_rWindowStatus.isVisible, c_rWindowStatus.isMinimized, c_rWindowStatus.ixPosition, c_rWindowStatus.iyPosition, c_rWindowStatus.iHeight);
}
