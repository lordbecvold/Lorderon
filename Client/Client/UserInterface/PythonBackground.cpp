...
void CPythonBackground::Update(float fCenterX, float fCenterY, float fCenterZ)
{
...
#if defined(WJ_COMBAT_ZONE)
	{
		...
		for (; itor != m_kMapCombatZone_dwTargetID_dwChrID.end(); ++itor)
		{
			...
			CreateSpecialEffect(dwTargetID, +kPixelPosition.x, -kPixelPosition.y, +kPixelPosition.z, g_strEffectTargetLeaving.c_str());
		}
	}
#endif
#ifdef __PERFORMANCE_CHECKER__
	...
	}
	{
		...
		for (; itor2 != m_kMap_dwTargetID_dwChrID2.end(); ++itor2)
		{
			...
			CreateSpecialEffect(dwTargetID2, +kPixelPosition2.x, -kPixelPosition2.y, +kPixelPosition2.z, g_strEffectShopSearch.c_str());
		}
	}
	{
