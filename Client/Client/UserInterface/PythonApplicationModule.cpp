...
#endif
#ifdef ENABLE_RENEW_MESSENGER_WHISPER
	PyModule_AddIntConstant(poModule, "ENABLE_RENEW_MESSENGER_WHISPER", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_RENEW_MESSENGER_WHISPER", 0);
#endif
