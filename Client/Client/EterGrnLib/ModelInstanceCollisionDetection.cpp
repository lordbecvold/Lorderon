...
void CGrannyModelInstance::MakeBoundBox(TBoundBox* pBoundBox, const float* mat, const float* OBBMin, const float* OBBMax, D3DXVECTOR3* vtMin, D3DXVECTOR3* vtMax)
{
...
bool CGrannyModelInstance::Intersect(const D3DXMATRIX * c_pMatrix, float *, float *, float * pt)
{
