...
class SelectCharacterWindow(ui.Window):
	...
	def Open(self):
		self.__LoadBoardDialog("twix_work/characterwindow/select/selectcharacterwindow.py")
	...
	def SelectSlot(self, index):
		...
		if 0 != id:
			...
			self.empireName.SetText(" %s" % {1:"Shinsoo", 2:"Chunjo", 3:"Jinno"}.get(net.GetEmpireID(), "None"))
