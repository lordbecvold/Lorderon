...
class GuildWindow(ui.ScriptWindow):
	...
	JOB_NAME = {0 : localeInfo.JOB_WARRIOR, 1 : localeInfo.JOB_ASSASSIN, 2 : localeInfo.JOB_SURA, 3 : localeInfo.JOB_SHAMAN,}
...
class BuildGuildBuildingWindow(ui.ScriptWindow):
	...
	if localeInfo.IsJAPAN():
		GUILD_CATEGORY_LIST = (("HEADQUARTER", "딈멳뙕뭱븿"), ("FACILITY", "둮뮗뙕뭱븿"), ("OBJECT", "궩궻뫜"),)
	elif localeInfo.IsYMIR() or localeInfo.IsWE_KOREA():
		GUILD_CATEGORY_LIST = (("HEADQUARTER", "본건물"), ("FACILITY", "기능건물"), ("OBJECT", "조경물"),)
		...
		try :
			...
			GUILD_CATEGORY_LIST = ( ("HEADQUARTER", "Main Building"), ("FACILITY", "Facility"), ("OBJECT", "Object"),)
