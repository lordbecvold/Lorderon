...
class Dialog1(ui.Window):
	...
	def BuildWindow(self):
		...
		self.chrRenderer.SetPosition(7, 30)
		self.chrRenderer.SetRenderTarget(self.RENDER_TARGET_INDEX)
		self.chrRenderer.Show()
		self.btnSet = self.comp.Button(self.Board, 'Set', '', 92, 220+40, self.btnSet_func, 'd:/ymir work/ui/public/small_button_01.sub', 'd:/ymir work/ui/public/small_button_02.sub', 'd:/ymir work/ui/public/small_button_03.sub')
		self.slotbar_txtModel, self.txtModel = self.comp.EditLine(self.Board, '101', 20, 220+40, 60, 15, 10)
