...
class BonusSelector(ui.Bar):
	def Activate(self):
		...
		self.sub_parent.StatusText.SetText("Aktivní")
		self.Starter.SetText("Toèení ("+str(self.index+1)+") ukonèit")
	...
	def Deactivate(self):
		...
		self.sub_parent.StatusText.SetText("Neaktivní")
		self.Starter.SetText("Toèení ("+str(self.index+1)+") spustit")
	...
	def Finish(self):
		...
		self.sub_parent.StatusText.SetText("Natoèeno")
		self.Starter.SetText("Toèení ("+str(self.index+1)+") ukonèeno")
		self.sub_parent.boni_active = 0
		if self.sub_parent.parentWindow.parentWindow.gameWindow != None:
	...
	def __init__(self,sub_parent):
		...
		for i in range(7,5,-1):
			...
			self.boni[vas][1] = DropDown(self,"- Prázdné -")
		...
		self.but_propose = DropDown(self,'Návrhy',0)
		...
		self.BlockText.SetText("Pøedmìt nelze toèit.")
		self.BlockText.Show()	
...
class ItemTabBar(ui.Window):
	...
	class ItemTab(ui.Bar):
		...
		def __init__(self,parent,tabnum,index = 0,vnum = 0):
			...
			self.CloseBut.SetToolTipText("Zavøít", 0, -23)
		...
		def SetIndex(self,index):
			...
			self.bonusSelector.Starter.SetText("Toèení ("+str(index+1)+") spustit")
			self.Update()
			self.UpdateItem()
	...
	def __init__(self,parent):
		...
		self.AddText.SetText("Vložte pøedmìt")
...
class Bot(ui.BoardWithTitleBar):
	class PinGroup(ui.Bar):
		...
		def __init__(self,parent,dir = 1):
			...
			self.maximise_but.SetText("Otevøít")
			...
			self.stop_but.SetText("Ukonèit vše")
	...
	def __init__(self):
		...
		self.but_deactivate_all.SetText("Zastavit vše")
