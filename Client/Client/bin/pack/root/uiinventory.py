...
class InventoryWindow(ui.ScriptWindow):
	...
	def ClickEquipmentPageButton(self):
		if self.wndEquipmentPage:
			if self.wndEquipmentPage.IsShow():
				self.wndEquipmentPage.Hide()
			else:
				self.wndEquipmentPage.Show()
		else:
			self.wndEquipmentPage = uiEquipmentChanger.EquipmentPageWindow()
			self.wndEquipmentPage.Show()
