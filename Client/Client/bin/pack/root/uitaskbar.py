...
class TaskBar(ui.ScriptWindow):
	...
	def LoadWindow(self):
		...
		toggleButtonDict[TaskBar.BUTTON_BONUS]=self.GetChild("BonusButton")
		toggleButtonDict[TaskBar.BUTTON_POLY]=self.GetChild("polyshopbutton")
		toggleButtonDict[TaskBar.BUTTON_TITLE]=self.GetChild("titlesys")
		try:
