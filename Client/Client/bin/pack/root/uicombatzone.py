...
class CombatZoneWindow(ui.ScriptWindow):
	...
	EMPIRE_IMAGE_DICT = {net.EMPIRE_A : ROOT_PATH + "empire_shinsu.sub",  net.EMPIRE_B : ROOT_PATH + "empire_chunjo.sub", net.EMPIRE_C : ROOT_PATH + "empire_jinno.sub"}
	...
	class CombatZoneDataDaysWindow(ui.Window):
		...
		NAME_OF_DAYS_LIST = [uiScriptLocale.BATTLE_FIELD_MONDAY, uiScriptLocale.BATTLE_FIELD_TUESDAY, uiScriptLocale.BATTLE_FIELD_WEDNESDAY, uiScriptLocale.BATTLE_FIELD_THURSDAY, uiScriptLocale.BATTLE_FIELD_FRIDAY, uiScriptLocale.BATTLE_FIELD_SATURDAY, uiScriptLocale.BATTLE_FIELD_SUNDAY]
