...
window = {
	...
	(
		...
		{
			"name" : "BeltInventoryLayer", "x" : 5, "y" : 0, "width" : 148, "height" : 139,
			"children" :
			(
				{
					"name" : "MinimizeBtn", "type" : "button", "x" : 2+4, "y" : 20, "width" : 10, "default_image" : "d:/ymir work/ui/game/biolog_system_vegas/btn_minimize_normal.tga", "over_image" : "d:/ymir work/ui/game/biolog_system_vegas/btn_minimize_over.tga", "down_image" : "d:/ymir work/ui/game/biolog_system_vegas/btn_minimize_down.tga", "disable_image" : "d:/ymir work/ui/game/biolog_system_vegas/btn_minimize_disabled.tga",
				},
				{
