...
window = {
	...
	(
		...
		},
		{
			...
			"y" : 3 + Y_ADD_POSITION,
			"tooltip_text" : "Bonus",
			"default_image" : ROOT + "TaskBar/realizari_1.tga",
			"over_image" : ROOT + "TaskBar/realizari_1.tga",
			"down_image" : ROOT + "TaskBar/realizari_2.tga",
		},
		{
			"name" : "polyshopbutton",
			"type" : "button",
			...
			"y" : 3 + Y_ADD_POSITION,
			"tooltip_text" : "poly",
			"default_image" : ROOT + "TaskBar/sterge_1.tga",
			"over_image" : ROOT + "TaskBar/sterge_1.tga",
			"down_image" : ROOT + "TaskBar/sterge_2.tga",
		},
		{
			"name" : "titlesys",
			"type" : "button",
			...
			"y" : 3 + Y_ADD_POSITION,
			"tooltip_text" : "ttile",
			"default_image" : ROOT + "TaskBar/title_1.tga",
			"over_image" : ROOT + "TaskBar/title_1.tga",
			"down_image" : ROOT + "TaskBar/title_2.tga",
		},
		{
