...
void CActorInstance::ProcessMotionEventEffectToTargetEvent(const CRaceMotionData::TMotionEventData * c_pData)
{
	...
	else
	{
		...
		if (c_pEffectToTargetData->isFollowing && IsFlyTargetObject())
		{
			...
			D3DXVECTOR3 v3Position(c_pEffectToTargetData->v3EffectPosition.x, c_pEffectToTargetData->v3EffectPosition.y, c_pEffectToTargetData->v3EffectPosition.z);
		...
		else
		{
			...
			D3DXVECTOR3 v3Position(c_rv3FlyTarget.x + c_pEffectToTargetData->v3EffectPosition.x, c_rv3FlyTarget.y + c_pEffectToTargetData->v3EffectPosition.y, c_rv3FlyTarget.z + c_pEffectToTargetData->v3EffectPosition.z);
